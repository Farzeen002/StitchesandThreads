...
$user=$_SESSION['u_id'];
$i=1;
$query=mysqli_query($con,"SELECT * from `tbl_design` d inner join tbl_material m on m.m_id=d.m_id  where fabric_id='$id'  ") or die(mysqli_error($con));
...
<tr>
	...
	<td><a href="dlt_frock.php?fid=<?php echo $row['fabric_id'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Cancel</i></a></td>
</tr>
<?php	}?>
</tbody>
