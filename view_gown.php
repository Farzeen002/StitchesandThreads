...
$user=$_SESSION['u_id'];
$i=1;
$query=mysqli_query($con,"SELECT d.*,m.m_id,m.m_type from `tbl_gown` d inner join tbl_material m on m.m_id=d.m_id  where g_id='$id'");
...
<tr>
	...
	<td><a href="dlt_gown.php?fid=<?php echo $row['g_id'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Cancel</i></a></td>
</tr>
<?php	}?>
</tbody>
