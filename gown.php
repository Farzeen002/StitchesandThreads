		...
		<div id="main" class="haslayout padding-section" style="padding:0px;">
			<div class="container">
				<form class="login-form creataccount-form" action="" method="POST" enctype="multipart/form-data">
					<fieldset>
						<div class="border-left"><h2>Gown MEASURMENT</h2></div>
						<div class="row">
							...
							<div class="form-group col-sm-6 col-xs-12">
								...
								<input type="text" class="form-control" name="sklength" placeholder="Skirt Length in cm" required="" autocomplete="off"><br>
							</div>
								<div class="form-group col-sm-6 col-xs-12">
								<label>Length:</label>
...
if(isset($_POST['submit']))
    {
        ...
        if(!empty($insertValuesSQL)){
            $insertValuesSQL = trim($insertValuesSQL,',');
             ...
             $insert = mysqli_query($con,"INSERT INTO `tbl_gown`(`g_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `SL`, `SW`, `chest`, `waist`, `hip`, `bodice`, `SKlength`, `length`, `sweep`, `shoulder`, `comment`, `image`, `uid`,`materialprice`) VALUES ('','$Mtype','$Qty','$Bookdate','$Deliverydate','$colour','$slength','$swidth','$chest','$waist','$Hip','$bodice','$sklength','$length','$sweep','$shoulder','$cmt','$insertValuesSQL','$user','$mprice')") or die(mysqli_error($con));
            ...
            if($insert){
              ...
              echo '<script> alert("Details are uploaded successfully.");window.location="view_gown.php?last_id='.$last_id.'";</script>';
            }
            else
            {
              echo '<script> alert("Sorry, there was an error uploading your details.");window.location="gown.php";</script>';
            }
            }
