		...
		<div id="main" class="haslayout padding-section" style="padding:0px;">
			<div class="container">
				<form class="login-form creataccount-form" action="" method="POST" enctype="multipart/form-data">
					<fieldset>
						<div class="border-left"><h2>Ladies TSHIRT MEASURMENT</h2></div>
						<div class="row">
						...
						<div class="form-group col-sm-6 col-xs-6 full-widthsx">
							<center><button type="submit" class="theme-btn btn-small" name="submit">Apply</button></center>
						</div>
...
if(isset($_POST['submit']))
    {
        ...
        if(!empty($insertValuesSQL)){
            ...
            $insert = mysqli_query($con,"INSERT INTO `tbl_gshirt`(`gs_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `pocket`, `SL`, `SW`, `chest`, `waist`, `hip`, `shoulder`, `length`, `comment`, `image`, `uid`,`materialprice`) VALUES  ('','$Mtype','$Qty','$Bookdate','$Deliverydate','$colour','$pocket','$slength','$swidth','$chest','$waist','$hips','$shoulder','$length','$cmt','$insertValuesSQL','$user','$mprice')") or die(mysqli_error($con));
            ...
            if($insert){
             ...
             $last_id=mysqli_insert_id($con);
              ...
              echo '<script> alert("Details are uploaded successfully.");window.location="view_gshirt.php?last_id='.$last_id.'";</script>';
            }
            else
            {
              echo '<script> alert("Sorry, there was an error uploading your details.");window.location="gshirt.php";</script>';
            }
            }
