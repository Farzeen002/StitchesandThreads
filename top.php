...
if(isset($_POST['submit']))
{
    ...
    foreach($_FILES['files']['name'] as $key=>$val){
        ...
        if(!empty($insertValuesSQL)){
            ...
            $insert = mysqli_query($con,"INSERT INTO `tbl_top`(`t_id`, `m_id`, `qty`, `book_date`, `delivery_date`, `colour`, `SL`, `SW`, `chest`, `waist`, `hip`, `bodice`, `SKlength`, `length`, `sweep`, `shoulder`, `comment`, `image`, `uid`,`materialprice`) VALUES ('','$Mtype','$Qty','$Bookdate','$Deliverydate','$colour','$slength','$swidth','$chest','$waist','$Hip','$bodice','$sklength','$length','$sweep','$shoulder','$cmt','$insertValuesSQL','$user','$mprice')") or die(mysqli_error($con));
			if($insert){
