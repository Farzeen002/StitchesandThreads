			...
			<div class="container">
				<form  action="" method="POST">
					...
					<?php
                        include('connect.php');
						$i=1;
						$query=mysqli_query($con,"SELECT tbl_assign.*,tbl_staff.staff_id,tbl_staff.staff_name,tbl_user.uid,tbl_user.full_name from `tbl_assign`,tbl_staff,tbl_user where tbl_user.uid=tbl_assign.uid and tbl_assign.staff_id=tbl_staff.staff_id") or die(mysqli_error($con));
						while ($row=mysqli_fetch_array($query)) {?>
							<tr>
								...
								<!-- <td> <a href="work.php?usr=<?php echo $row['uid'];?>&&aid=<?php echo $row['assign_id']; ?>" class="btn btn-info">Complete</a></td> -->
