			...
			<div class="container">
				<form  action="" method="POST">
					...
					<?php
                        include('connect.php');
						$i=1;
						$query=mysqli_query($con,"SELECT tbl_assign.type,status,id,tbl_staff.staff_id,tbl_staff.staff_name,tbl_user.full_name,tbl_user.contact FROM `tbl_assign`,tbl_staff,tbl_user where tbl_staff.staff_id=tbl_assign.staff_id and tbl_staff.staff_id='$staff_id' and tbl_assign.uid=tbl_user.uid  ") or die(mysqli_error($con));
                                 ...
                                 <?php 
                                     ...
                                     <td><?php echo $row['full_name'];?></td>
								 	 ...
								 	 <?php $ps=$row['status'];
                                                 ...
                                                 {
                                            ?>
                                        <td>  <a href="update.php?sid=<?php echo $id; ?>" class="btn btn-warning" title="complete">Update</a></td>
                                ...
                                <?php
								 ...
								 <?php $ps=$row['status'];
                                  ...
                                  <td><a href="update.php?id=<?php echo $id; ?>"
                                    class="btn btn-warning" title="complete">Update</a></td>
                                           <?php }elseif($ps=='Complete')
                                                  { ?>
                                         <td>  Completed. </td>
                                     <?php }  }?>		
							</tr>
