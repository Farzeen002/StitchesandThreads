			...
			<div class="container">
				<form  action="" method="POST">
					...
					<?php
                        include('connect.php');
						$i=1;
						$query=mysqli_query($con,"SELECT * from `tbl_supply`") or die(mysqli_error($con));
						while ($row=mysqli_fetch_array($query)) {?>
							<tr>
								...
								<td><a href="supply_dlt.php?sid=<?php echo $row['supid'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Delete</i></a></td>								
							</tr>
					<?php	}?>
				</tbody>
				</table>
