	...
	<div id="wrapper">
		...
		<div class="banner haslayout">
			...
			<div id="home-slider" class="home-slider">
				<div class="item">
					<video  autoplay muted  style="width:100%; height:10%" loop >
  <source src="images/home-slider/a1.mp4" type="video/mp4">
</video>
				</div>
				<div class="item">
							...
							<div class="row">
								<div class="col-sm-5">
									<figure class="frame-img">
										<img src="../photos/about.jpg" alt="image description">
									</figure>
								</div>
								<div class="col-sm-7">
					...
					<div id="product-slider" class="product-slider haslayout">
						<div class="item product">
							<div class="product-img">
								<img src="../photos/bg1.jpg" style="width:900px;" alt="image description">
							...
							<div class="detail">
								<span class="title">Nehru Suit</span>
								<span class="stars">
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/c1.jpg" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
							...
							<div class="detail">
								<span class="title">Ladies salwar</span>
								<span class="stars">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/c2.webp" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/c3.webp" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/c4.png" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/c12.jpeg" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
				...
				<div class="container">
					<div class="col-md-6 col-md-offset-3">
						<div class="row">
							...
							<span class="copyright">&copy;Designed by Farzeen Ahmed </a></span>
						</div>
					</div>
				</div>
			</div>
