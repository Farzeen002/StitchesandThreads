				...
				<form  action="" method="POST" enctype="multipart/form-data">
					...
					<div class="col-md-3"></div>
						...
						<div class=" col-md-6 col-sm-6 col-xs-6 col-offset-sm-3 reg-customers">
							...
							<div class="form-group">
								...
								<select  name ="staff" class="form-control">
							        ...
							        <?php 
							        include('connect.php');
							        $q=mysqli_query($con,"SELECT * from tbl_staff ")or die(mysqli_query($con));
							        while($r=mysqli_fetch_array($q)){
							        	?>
							        	<option value="<?php echo $r['staff_id'];?>"><?php echo $r['staff_name'];?></option>
							        	<?php
							        }
							        ?>
     							</select>
						...
						<div class="form-group clearfix">
								...
								<button type="submit" class="theme-btn btn-small" name="submit">Submit</button>
							</div>
						</div>
       ...
       $ad_name=$_SESSION['admin_name']; 
                        ...
                        if(isset($_POST['submit']))
                        {
                               $staff=$_POST['staff'];
		                            ...
		                            $qry=mysqli_query($con,"INSERT INTO `tbl_assign`(`assign_id`, `id`, `staff_id`,`uid` ,`type`, `date`) VALUES ('','$id','$staff','$usr','$type','$date')")or die(mysqli_error($con));
		                            if($qry)
		                            {
