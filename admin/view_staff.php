					...
					<?php
						...
						while ($row=mysqli_fetch_array($query)) {?>
							<tr>
								...
								<td><img src="photos/<?php echo $row['image'];?>" height='70' width='60';></td>
								<td><?php echo $row['address'];?></td>
								<td><?php echo $row['phone'];?></td>
								<td><?php echo $row['gender'];?></td>
								<td><a href="staff_dlt.php?sid=<?php echo $row['staff_id'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Delete</i></a></td>
								<td><a href="staff_update.php?sid=<?php echo $row['staff_id'];?>" class="btn btn-info"><i class="fa fa-edit">&nbsp;&nbsp;Update</i></a></td>
