			...
			<div class="container">
				<form  action="" method="POST">
					...
					<?php
                        include('connect.php');
						$i=1;
						$query=mysqli_query($con,"SELECT * from `tbl_material` ") or die(mysqli_error($con));
						while ($row=mysqli_fetch_array($query)) {?>
							<tr>
								...
								<td><a href="material_dlt.php?mid=<?php echo $row['m_id'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Delete</i></a></td>
								<td><a href="material_update.php?mid=<?php echo $row['m_id'];?>" class="btn btn-info"><i class="fa fa-edit">&nbsp;&nbsp;Update</i></a></td>
							</tr>
					<?php	}?>
				</tbody>
				</table>	
