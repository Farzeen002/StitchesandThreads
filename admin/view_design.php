			...
			<div class="container">
				<form  action="" method="POST">
					...
					<?php
                        include('connect.php');
						$i=1;
						$query=mysqli_query($con,"SELECT * FROM `tbl_design_data`  ") or die(mysqli_error($con));
						while ($row=mysqli_fetch_array($query)) {?>
							<tr>
								<td><?php echo $i++;?></td>
								<td><?php echo $row['design_name'];?></td>
								<td><img src="photos/<?php echo $row['design_image'];?>" height='70' width='60';></td>
								<td><a href="design_dlt.php?did=<?php echo $row['design_id'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Delete</i></a></td>
