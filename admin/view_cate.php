			...
			<div class="container">
				<form  action="" method="POST">
					...
					<?php
                        include('connect.php');
						$i=1;
						$query=mysqli_query($con,"SELECT * FROM `tbl_cate` ") or die(mysqli_error($con));
						while ($row=mysqli_fetch_array($query)) {?>
							<tr>
								<td><?php echo $i++;?></td>
								<td><?php echo $row['category_type'];?></td>
								<td><a href="cate_dlt.php?catid=<?php echo $row['cid'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Delete</i></a></td>
								<td><a href="cate_update.php?catid=<?php echo $row['cid'];?>" class="btn btn-info"><i class="fa fa-edit">&nbsp;&nbsp;Update</i></a></td>
