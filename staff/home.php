	...
	<div id="wrapper">
		...
		<div class="banner haslayout">
					...
					<div class="holder">
						<div class="frame">
							 <div class="border-center">
								<span class="title">STITCHES AND THREADS</span>
							</div> 
							<div class="border-center">
								<h1>Design your <span>Dress Online</span></h1>
							</div>
			...
			<div id="home-slider" class="home-slider">
				<div class="item">
					<img src="images/home-slider/img1.jpg" alt="image description">
				</div>
				<div class="item">
					<img src="images/home-slider/img2.jpg" alt="image description">
				</div>
				<div class="item">
					...
					<div id="product-slider" class="product-slider haslayout">
						<div class="item product">
							<div class="product-img">
								<img src="../photos/4a.jpg" alt="image description">
							...
							<div class="detail">
								<span class="title">Long Gown/ Salwar</span>
								<span class="stars">
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/shirt 2.jpeg" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
							...
							<div class="detail">
								<span class="title">Men's shirt</span>
								<span class="stars">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
						...
						<div class="item product">
							...
							<div class="detail">
								<span class="title">Men's T-shirt</span>
								<span class="stars">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/regbg.jpg" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
							...
							<div class="detail">
								<span class="title">ladies frock</span>
								<span class="stars">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/1.jpeg" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
							...
							<div class="detail">
								<span class="title">Men's garnd coats</span>
								<span class="stars">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
						...
						<div class="item product">
							<div class="product-img">
								<img src="../photos/IMG_20190126_203312 - Copy.jpg" alt="image description">
								<div class="cart-badge">
									<span class="corner"></span>
								</div>
								<div class="img-hover">
					...
					<div class="row">
						<div class="col-md-4 col-sm-12 col-xs-12">
							<div class="col service">
								...
								<figure>
									<img src="../photos/SERVICE.jpg" alt="image description">
								</figure>
								<div class="description">
						...
						<div class="col-md-4 col-sm-6 col-xs-6">
							...
							<div class="description">
									<p>Stitches & Threads is the e-commerce leader in custom clothing and dresses, as we offer to all people complete freedom to design their own clothes by choosing from a wide range of styles and fabrics.</p>
								</div>
								<ul>
									<li>Trusted sewers, ready to serve.</li>
									<li>Select the fabric.</li>
									<li>Design your dress.</li>
									<li>Give the measurements and make it done.</li>
						...
						<div class="col-md-4 col-sm-6 col-xs-6">
							<div class="col info">
								...
								<div class="description">
									<p>To contact us please do call at the phone number given below or visit our outlet followed by the address given below.</p>
								</div>
								<ul class="address-info">
									<li>
										<i class="fa fa-map-marker"></i>
										<address>Ground floor, Empiremall, STITCHES AND THREADS ,mangalore</address>
									</li>
									<li>
		...
		<footer id="footer" class="footer haslayout">
			...
			<div class="getstarted haslayout small-padding-section">
				<div class="container">
					<h3>MAKING THE BEST CLOTHES EVERYDAY</h3>
				...
				<div class="container">
					<div class="col-md-6 col-md-offset-3">
						<div class="row">
							<strong class="logo">
								<a href="index.html">
									<img src="../photos/LOGO.jpeg" alt="image description">
							</strong>
							<div class="description">
								<p><br>Design Your Dress Online<br>MAKING EVERY OCCASION EXTRA SPECIAL</p>
							</div>
							<span class="copyright">&copy;Designed by Farzeen & Hilal </a></span>
						</div>
					</div>
				</div>
			</div>
