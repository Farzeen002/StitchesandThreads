...
$i=1;
$query=mysqli_query($con,"SELECT d.*,m.m_id,m.m_type,u.uid,u.full_name,u.contact,u.gender,u.address,u.email,u.password,u.image as img from `tbl_gshirt` d inner join tbl_material m on m.m_id=d.m_id inner join tbl_user u on u.uid=d.uid  ") or die(mysqli_error($con)); 
