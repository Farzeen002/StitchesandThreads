...
$i=1;
$query=mysqli_query($con,"SELECT f.*,m.m_id,m.m_type,u.uid,u.full_name,u.contact,u.gender,u.address,u.email,u.password,u.image as img from `tbl_frock` f inner join tbl_material m on m.m_id=f.m_id inner join tbl_user u on u.uid=f.uid ") or die(mysqli_error($con));
