...
$i=1;
$query=mysqli_query($con,"SELECT d.*,m.m_id,m.m_type,u.full_name,u.uid from `tbl_blouse` d inner join tbl_material m on m.m_id=d.m_id  inner join tbl_user u on u.uid=d.uid   ") or die(mysqli_error($con));
