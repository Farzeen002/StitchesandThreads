...
$user=$_SESSION['u_id'];
$i=1;
$query=mysqli_query($con,"SELECT d.*,m.m_id,m.m_type from `tbl_frock` d inner join tbl_material m on m.m_id=d.m_id  where f_id='$id'");
...
<tr>
	...
	<td><a href="dlt_frock.php?fid=<?php echo $row['f_id'];?>" class="btn btn-danger"><i class="fa fa-trash">&nbsp;&nbsp;Cancel</i></a></td>
</tr>
<?php	}?>
</tbody>
